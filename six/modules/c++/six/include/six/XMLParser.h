...
struct SIX_SIX_API XMLParser
{
    ...
    static void setAttribute(xml::lite::Element& e,
                             ...
                             const std::string& uri = "")
    {
        return XmlLite::setAttribute(
                e, xml::lite::QName(xml::lite::Uri(uri), name), i);
    }
    ...
    {
        assert(parent != nullptr);
        return &mXmlLite.createSixString(
                xml::lite::QName(xml::lite::Uri(uri), name), t, *parent);
    }
...
protected:
    ...
    static XMLElem newElement(const std::string& name,
                              const std::string& uri,
                              XMLElem prnt = nullptr);
    static xml::lite::Element& newElement(const std::string& name,
                                          const std::string& uri,
    ...
    template <typename T>
    static XMLElem newElement(const T* pElement,
                              const std::string& name,
                              const std::string& uri,
                              XMLElem parent = nullptr)
    {
        return XmlLite::newElement(pElement,
                                   xml::lite::QName(xml::lite::Uri(uri), name),
                                   parent);
    }
    ...
    {
        assert(parent != nullptr);
        return &mXmlLite.createInt(xml::lite::QName(xml::lite::Uri(uri), name),
                                   p,
                                   *parent);
    }
    XMLElem createInt(const std::string& name,
    ...
    static void setAttribute(XMLElem e,
                             const std::string& name,
                             const std::string& s,
                             const std::string& uri = "")
    {
    ...
    static XMLElem getOptional(const xml::lite::Element* parent,
                               const std::string& tag);
    static xml::lite::Element* getOptional(const xml::lite::Element& parent,
                                           const std::string& tag);

    template <typename T>
    static XMLElem getOptional_reset(const xml::lite::Element& parent,
                                     const std::string& tag,
    ...
    template <typename T>
    static XMLElem getOptional_reset(const xml::lite::Element& parent,
                                     XsElement_minOccurs0<T>& obj)
    {
        return XmlLite::getOptional_reset(parent, obj);
    }

    static XMLElem getFirstAndOnly(const xml::lite::Element* parent,
                                   const std::string& tag);
    static xml::lite::Element& getFirstAndOnly(const xml::lite::Element& parent,
                                               const std::string& tag);

    void getFirstAndOnly(const xml::lite::Element& parent,
                         const std::string& tag,
                         double&) const;
