...
// `std::complex<short>` is (no longer) valid C++, some compilers issue
// warnings. Since SIX is the primary "culprit," let it sort things out using
// infrastrcture from CODA-OSS.
