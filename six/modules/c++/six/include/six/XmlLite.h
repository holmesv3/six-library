...
{
    XmlLite(const xml::lite::Uri& defaultURI,
    ...
    static xml::lite::Element* newElement(const xml::lite::QName&,
                                          xml::lite::Element* prnt);
    static xml::lite::Element& newElement(const xml::lite::QName&,
                                          xml::lite::Element& prnt);
    xml::lite::Element* newElement(const std::string& name,
                                   xml::lite::Element* prnt) const;
    xml::lite::Element& newElement(const std::string& name,
                                   xml::lite::Element& prnt) const;
    static xml::lite::Element* newElement(const xml::lite::QName&,
    ...
    static xml::lite::Element& newElement(const xml::lite::QName&,
                                          ...
                                          xml::lite::Element& parent);
    template <typename T>
    static xml::lite::Element* newElement(const T* pElement,
    ...
    xml::lite::Element& createString(const xml::lite::QName&,
                                     const std::string& p,
    ...
    xml::lite::Element& createString(const xml::lite::QName&,
                                     ...
                                     xml::lite::Element& parent) const;
    template <typename T>
    xml::lite::Element& createSixString(const xml::lite::QName& name,
                                        const T& t,
                                        xml::lite::Element& parent)
            const  // six::toString(t) isntead of t.toString()
    {
        return createString(name, six_toString(t), parent);
    }
    xml::lite::Element& createInt(const xml::lite::QName& name,
                                  const std::string& p,
                                  xml::lite::Element& parent) const;
    xml::lite::Element& createInt(const xml::lite::QName& name,
                                  int p,
                                  xml::lite::Element& parent) const;
    xml::lite::Element& createDouble(const xml::lite::QName&,
                                     double p,
                                     xml::lite::Element& parent) const;
    xml::lite::Element& createDouble(const xml::lite::QName&,
                                     const std::optional<double>& p,
                                     xml::lite::Element& parent) const;
    xml::lite::Element* createOptionalDouble(const xml::lite::QName&,
                                             double p,
                                             xml::lite::Element& parent) const;
    xml::lite::Element* createOptionalDouble(const xml::lite::QName&,
                                             const std::optional<double>& p,
                                             xml::lite::Element& parent) const;
    xml::lite::Element* createBooleanType(const xml::lite::QName&,
                                          BooleanType b,
                                          xml::lite::Element& parent) const;
    xml::lite::Element& createDateTime(const xml::lite::QName&,
                                       const DateTime& p,
                                       xml::lite::Element& parent) const;
    xml::lite::Element& createDate(const xml::lite::QName&,
                                   const DateTime& p,
                                   xml::lite::Element& parent) const;
    ...
    template <typename T>
    xml::lite::Element& createSixString(
            const std::string& name,
            const T& t,  // six::toString(t) isntead of t.toString()
            xml::lite::Element& parent) const
    {
    ...
    template <typename T>
    xml::lite::Element& createInt(const std::string& name,
                                  T p,
                                  xml::lite::Element& parent) const
    {
    ...
    xml::lite::Element* createOptional(const xml::lite::QName&,
                                       const std::optional<bool>&,
                                       xml::lite::Element& parent) const;
    xml::lite::Element* createOptional(const xml::lite::QName&,
                                       const std::optional<std::u8string>&,
                                       xml::lite::Element& parent) const;
    ...
    void parseDouble(const xml::lite::Element& element,
                     std::optional<double>& value) const;
    bool parseOptionalDouble(const xml::lite::Element& parent,
                             const std::string& tag,
                             double& value) const;
    bool parseOptionalDouble(const xml::lite::Element& parent,
                             const std::string& tag,
                             std::optional<double>& value) const;
    void parseComplex(const xml::lite::Element& element,
                      six::zdouble& value) const;
    void parseString(const xml::lite::Element* element,
                     std::string& value) const;
    void parseString(const xml::lite::Element&, std::string&) const;

    void parseBooleanType(const xml::lite::Element& element,
    ...
    bool parseOptionalString(const xml::lite::Element& parent,
                             const std::string& tag,
                             std::string& value) const;

    template <typename T>
    bool parseOptionalInt(const xml::lite::Element& parent,
                          const std::string& tag,
                          T& value) const
    {
    ...
    void parseDateTime(const xml::lite::Element& element,
                       DateTime& value) const;

    static void setAttribute(xml::lite::Element& e,
                             const xml::lite::QName& name,
                             size_t i)
    {
    ...
    static xml::lite::Element* getOptional(const xml::lite::Element& parent,
                                           const std::string& tag);
    static xml::lite::Element* getOptional(const xml::lite::Element& parent,
                                           const xml::lite::QName& tag);

    template <typename T>
    inline static xml::lite::Element* getOptional_reset(
            const xml::lite::Element& parent,
            const std::string& tag,
            mem::ScopedCopyablePtr<T>& obj)
    {
    ...
    template <typename T>
    inline static xml::lite::Element* getOptional_reset(
            const xml::lite::Element& parent, XsElement_minOccurs0<T>& obj)
    {
    ...
    static xml::lite::Element& getFirstAndOnly(const xml::lite::Element& parent,
                                               const std::string& tag);
    static xml::lite::Element& getFirstAndOnly(const xml::lite::Element& parent,
    ...
    static void setAttribute(xml::lite::Element&,
                             const xml::lite::QName&,
                             const std::string& v);

private:
    xml::lite::Element& createInt_(const std::string& name,
                                   int p,
                                   xml::lite::Element& parent) const;
    xml::lite::Element& createString_(const std::string& name,
                                      const std::string& p,
                                      xml::lite::Element& parent) const;
...
template <>
inline xml::lite::Element& XmlLite::createString(
        const std::string& name,
        const std::string& p,
        xml::lite::Element& parent) const
{
...
SIX_SIX_API xml::lite::Element& create(const XmlLite&,
                                       const XsElement<double>&,
                                       xml::lite::Element& parent);
SIX_SIX_API void getFirstAndOnly(const XmlLite&,
                                 const xml::lite::Element&,
                                 XsElement<double>&);

SIX_SIX_API xml::lite::Element* create(const XmlLite&,
                                       const XsElement_minOccurs0<bool>&,
                                       xml::lite::Element& parent);
SIX_SIX_API xml::lite::Element* create(const XmlLite&,
                                       const XsElement_minOccurs0<double>&,
                                       xml::lite::Element& parent);
SIX_SIX_API xml::lite::Element* create(
        const XmlLite&,
        const XsElement_minOccurs0<std::u8string>&,
        xml::lite::Element& parent);

SIX_SIX_API bool parse(const XmlLite&,
                       const xml::lite::Element&,
                       XsElement_minOccurs0<bool>&);
SIX_SIX_API bool parse(const XmlLite&,
                       const xml::lite::Element&,
                       XsElement_minOccurs0<double>&);
SIX_SIX_API bool parse(const XmlLite&,
                       const xml::lite::Element&,
                       XsElement_minOccurs0<std::u8string>&);
