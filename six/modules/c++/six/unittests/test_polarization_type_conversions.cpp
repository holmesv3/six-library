...
static void test_EnumConstructor(const std::string& testName,
...
{
    test_EnumConstructor<six::DualPolarizationType>(
            testName, "OTHER", six::DualPolarizationType::OTHER);
    test_EnumConstructor<six::DualPolarizationType>(
            testName, "UNKNOWN", six::DualPolarizationType::UNKNOWN);
    test_EnumConstructor<six::DualPolarizationType>(
            testName, "V_V", six::DualPolarizationType::V_V);
    test_EnumConstructor<six::DualPolarizationType>(
            testName, "E_V", six::DualPolarizationType::E_V);  // SICD 1.3

    test_EnumConstructor<six::PolarizationType>(testName,
                                                "OTHER",
                                                six::PolarizationType::OTHER);
    test_EnumConstructor<six::PolarizationType>(testName,
                                                "UNKNOWN",
                                                six::PolarizationType::UNKNOWN);
    test_EnumConstructor<six::PolarizationType>(
            testName, "X", six::PolarizationType::X);  // SICD 1.3

    test_EnumConstructor<six::PolarizationSequenceType>(
            testName, "OTHER", six::PolarizationSequenceType::OTHER);
    test_EnumConstructor<six::PolarizationSequenceType>(
            testName, "UNKNOWN", six::PolarizationSequenceType::UNKNOWN);
    test_EnumConstructor<six::PolarizationSequenceType>(
            testName, "SEQUENCE", six::PolarizationSequenceType::SEQUENCE);
    test_EnumConstructor<six::PolarizationSequenceType>(
            testName, "X", six::PolarizationSequenceType::X);  // SICD 1.3
}

template <typename TSixEnum>
static void test_toType_(const std::string& testName,
                         const std::string& strType,
                         TSixEnum type)
{
    (void)testName;
...
TEST_CASE(ToType)
{
    test_toType_<six::DualPolarizationType>(testName,
                                            "V_V",
                                            six::DualPolarizationType::V_V);
    test_toType_<six::DualPolarizationType>(
            testName, "E_V", six::DualPolarizationType::E_V);  // SICD 1.3
    test_toType<six::DualPolarizationType>(testName, 85);

    test_toType_<six::PolarizationType>(testName,
                                        "X",
                                        six::PolarizationType::X);  // SICD 1.3
    test_toType<six::PolarizationType>(testName, 12);

    test_toType_<six::PolarizationSequenceType>(
            testName, "X", six::PolarizationSequenceType::X);  // SICD 1.3
    test_toType_<six::PolarizationSequenceType>(
            testName, "SEQUENCE", six::PolarizationSequenceType::SEQUENCE);
...
TEST_CASE(DualPolarizationType_ToType_OTHER)
{
    test_toType_OTHER<six::DualPolarizationType>(
            "DualPolarizationType_ToType_OTHER");
    ...
    TEST_EXCEPTION(six::DualPolarizationType::toType(
            "OTHER_xyz"));  // no "top level" OTHER.*
}

template <typename TSixEnum>
static void test_six_toType_(const std::string& testName,
                             const std::string& strType,
                             TSixEnum type)
{
    (void)testName;
...
TEST_CASE(SixToType)
{
    test_six_toType_<six::DualPolarizationType>(testName,
                                                "V:V",
                                                six::DualPolarizationType::V_V);
    test_six_toType_<six::DualPolarizationType>(
            testName, "E:V", six::DualPolarizationType::E_V);  // SICD 1.3
    test_six_toType_<six::DualPolarizationType>(
            testName, "UNKNOWN", six::DualPolarizationType::UNKNOWN);
    test_six_toType<six::DualPolarizationType>(testName, 85);

    test_six_toType_<six::PolarizationType>(
            testName, "X", six::PolarizationType::X);  // SICD 1.3
    test_six_toType_<six::PolarizationType>(
            testName,
            "OTHER_abc",
            six::PolarizationType::OTHER);  // SIDD 3.0/SICD 1.3
    test_six_toType<six::PolarizationType>(testName, 12);

    test_six_toType_<six::PolarizationSequenceType>(
            testName, "X", six::PolarizationSequenceType::X);  // SICD 1.3
    test_six_toType_<six::PolarizationSequenceType>(
            testName, "SEQUENCE", six::PolarizationSequenceType::SEQUENCE);
    test_six_toType_<six::PolarizationSequenceType>(
    ...
    test_six_toType_<six::PolarizationSequenceType>(
            testName,
            "OTHER_abc",
            six::PolarizationSequenceType::OTHER);  // SIDD 3.0/SICD 1.3
    test_six_toType<six::PolarizationSequenceType>(testName, 13);

    auto toTypeDual = six::DualPolarizationType::toType("V_OTHER");
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::V_OTHER);
    toTypeDual = six::toType<six::DualPolarizationType>(
            "V:OTHER_xyz");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::V_OTHER);
    toTypeDual = six::DualPolarizationType::toType("OTHER_V");
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::OTHER_V);
    toTypeDual = six::toType<six::DualPolarizationType>(
            "OTHER_xyz:V");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::OTHER_V);
    toTypeDual = six::toType<six::DualPolarizationType>(
            "OTHER_abc:OTHER");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::OTHER_OTHER);
    toTypeDual = six::toType<six::DualPolarizationType>(
            "OTHER:OTHER_xyz");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::OTHER_OTHER);
    toTypeDual = six::toType<six::DualPolarizationType>(
            "OTHER_abc:OTHER_xyz");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toTypeDual, six::DualPolarizationType::OTHER_OTHER);
}

template <typename TSixEnum>
static void test_ToString_(const std::string& testName,
                           const std::string& strType,
                           TSixEnum type)
{
    (void)testName;
...
TEST_CASE(ToString)
{
    test_ToString_<six::DualPolarizationType>(testName,
                                              "V_V",
                                              six::DualPolarizationType::V_V);
    test_ToString_<six::DualPolarizationType>(
            testName, "E_V", six::DualPolarizationType::E_V);  // SICD 1.3
    test_ToString<six::DualPolarizationType>("ToString");

    test_ToString_<six::PolarizationType>(testName,
                                          "V",
                                          six::PolarizationType::V);
    test_ToString_<six::PolarizationType>(
            testName, "X", six::PolarizationType::X);  // SICD 1.3
    test_ToString<six::PolarizationType>("ToString");

    test_ToString_<six::PolarizationSequenceType>(
            testName, "V", six::PolarizationSequenceType::V);
    test_ToString_<six::PolarizationSequenceType>(
            testName, "X", six::PolarizationSequenceType::X);  // SICD 1.3
    test_ToString_<six::PolarizationSequenceType>(
            testName, "SEQUENCE", six::PolarizationSequenceType::SEQUENCE);
...
TEST_CASE(DualPolarizationType_ToString_OTHER)
{
    ...
    TEST_ASSERT_EQ(toType_DualPolarization,
                   six::DualPolarizationType::OTHER_OTHER);
    TEST_ASSERT_EQ("OTHER_OTHER", toType_DualPolarization.toString());
}
TEST_CASE(DualPolarizationType_SixToType_OTHER)
{
    auto toType_DualPolarization =
            six::toType<six::DualPolarizationType>("OTHER");
    TEST_ASSERT_EQ(toType_DualPolarization, six::DualPolarizationType::OTHER);
    TEST_ASSERT_EQ("OTHER", toType_DualPolarization.toString());

    TEST_EXCEPTION(six::toType<six::DualPolarizationType>(
            "OTHER_abc"));  // no "top level" OTHER.*
    ...
    toType_DualPolarization = six::toType<six::DualPolarizationType>(
            "V:OTHER_xyz");  // SICD 1.3 "OTHER.*"
    TEST_ASSERT_EQ(toType_DualPolarization, six::DualPolarizationType::V_OTHER);
    TEST_ASSERT_EQ("V_OTHER", toType_DualPolarization.toString());
    ...
    toType_DualPolarization =
            six::toType<six::DualPolarizationType>("OTHER:OTHER");
    TEST_ASSERT_EQ(toType_DualPolarization,
                   six::DualPolarizationType::OTHER_OTHER);
    TEST_ASSERT_EQ("OTHER_OTHER", toType_DualPolarization.toString());
    ...
    TEST_ASSERT_EQ(toType_DualPolarization,
                   six::DualPolarizationType::OTHER_OTHER);
    TEST_ASSERT_EQ("OTHER_OTHER", toType_DualPolarization.toString());
    TEST_ASSERT_EQ("OTHER_abc:OTHER_xyz",
                   six::toString(toType_DualPolarization));
    ...
    TEST_EXCEPTION(six::toString(
            toType_DualPolarization));  // OTHER_OTHER, not OTHER_V
}

template <typename TSixEnum>
static void test_six_toString_(const std::string& testName,
                               const std::string& strType,
                               TSixEnum type)
{
    (void)testName;
    ...
    TEST_ASSERT_EQ(polarizationString,
                   six::toString(type));  // no template parameter
...
{
    test_six_toString_<six::DualPolarizationType>(
            testName, "V:V", six::DualPolarizationType::V_V);
    test_six_toString_<six::DualPolarizationType>(
            testName, "E:V", six::DualPolarizationType::E_V);  // SICD 1.3
    test_six_toString<six::DualPolarizationType>(testName);

    test_six_toString_<six::PolarizationType>(testName,
                                              "V",
                                              six::PolarizationType::V);
    test_six_toString_<six::PolarizationType>(
            testName, "X", six::PolarizationType::X);  // SICD 1.3
    test_six_toString_<six::PolarizationType>(
            testName, "OTHER_abc", six::PolarizationType::OTHER);  // SICD 1.3

    test_six_toString_<six::PolarizationSequenceType>(
            testName, "V", six::PolarizationSequenceType::V);
    test_six_toString_<six::PolarizationSequenceType>(
            testName, "X", six::PolarizationSequenceType::X);  // SICD 1.3
    test_six_toString_<six::PolarizationSequenceType>(
    ...
    test_six_toString_<six::PolarizationSequenceType>(
            testName,
            "OTHER_abc",
            six::PolarizationSequenceType::OTHER);  // SICD 1.3
...
static void test_NotSet(const std::string& testName)
{
    ...
    TEST_EXCEPTION(polarizationString =
                           pType.toString(true /*throw_if_not_set*/));
...
template <typename TSixEnum>
static void test_EqInt_(const std::string& testName,
                        const std::string& strType,
                        TSixEnum type,
                        int enumValue)
{
...
static void test_EqInt(const std::string& testName, int unknownEnumValue)
{
    ...
    static const std::vector<int> invalidIntValuesToTest{
            -1, 0, six::NOT_SET_VALUE - 1};
...
TEST_CASE(EqInt)
{
    test_EqInt_<six::PolarizationType>(testName,
                                       "V",
                                       six::PolarizationType::V,
                                       2);
    test_EqInt_<six::PolarizationType>(testName,
                                       "X",
                                       six::PolarizationType::X,
                                       7);  // SICD 1.3
    test_EqInt<six::PolarizationType>(testName, 6 /*unknownEnumValue*/);

    test_EqInt_<six::PolarizationSequenceType>(testName,
                                               "V",
                                               six::PolarizationSequenceType::V,
                                               2);
    test_EqInt_<six::PolarizationSequenceType>(testName,
                                               "X",
                                               six::PolarizationSequenceType::X,
                                               8);  // SICD 1.3
    test_EqInt_<six::PolarizationSequenceType>(
            testName, "SEQUENCE", six::PolarizationSequenceType::SEQUENCE, 7);
    test_EqInt<six::PolarizationSequenceType>(testName, 6 /*unknownEnumValue*/);
}
TEST_CASE(DualPolarizationType_EqInt)
{
    test_EqInt_<six::DualPolarizationType>(testName,
                                           "V_V",
                                           six::DualPolarizationType::V_V,
                                           2);
    test_EqInt_<six::DualPolarizationType>(testName,
                                           "E_V",
                                           six::DualPolarizationType::E_V,
                                           56);  // SICD 1.3
    test_EqInt_<six::DualPolarizationType>(testName,
                                           "OTHER_V",
                                           six::DualPolarizationType::OTHER_V,
                                           75);
    test_EqInt_<six::DualPolarizationType>(
            testName,
            "OTHER_OTHER",
            six::DualPolarizationType::OTHER_OTHER,
            83);
...
TEST_CASE(DualPolarization)
{
    ...
    // and one RCV value. Allowed TX values: “V”, “H”, “X”, “Y”, “S”, “E”,
    ...
    for (auto&& tx : map)
    {
        ...
        if ((txType == six::PolarizationType::NOT_SET) ||
            (txType == six::PolarizationType::UNKNOWN))
        {
            continue;
        }
        for (auto&& rcv : map)
        {
            ...
            if ((rcvType == six::PolarizationType::NOT_SET) ||
                (rcvType == six::PolarizationType::UNKNOWN))
            {
                continue;
            }
...
TEST_MAIN(TEST_CHECK(DualPolarization); TEST_CHECK(DualPolarizationType_EqInt);
