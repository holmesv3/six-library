...
XMLParser::XMLParser(const std::string& defaultURI,
                     ...
                     logging::Logger* log,
                     bool ownLog) :
    mXmlLite(xml::lite::Uri(defaultURI), addClassAttributes, log, ownLog)
{
}
XMLParser::XMLParser(const std::string& defaultURI,
                     bool addClassAttributes,
...
xml::lite::Element& XMLParser::newElement(const std::string& name,
...
XMLElem XMLParser::newElement(const std::string& name,
                              ...
                              XMLElem parent)
{
    return XmlLite::newElement(xml::lite::QName(xml::lite::Uri(uri), name),
                               parent);
}
xml::lite::Element& XMLParser::newElement(const std::string& name,
                                          const std::string& uri,
                                ...
                                XMLElem parent) const
{
    ...
    return &mXmlLite.createString(xml::lite::QName(xml::lite::Uri(uri), name),
                                  p,
                                  *parent);
}
...
{
    assert(parent != nullptr);
    return &mXmlLite.createDouble(xml::lite::QName(xml::lite::Uri(uri), name),
                                  p,
                                  *parent);
}
XMLElem XMLParser::createDouble(const std::string& name,
...
xml::lite::Element& XMLParser::createDouble(const std::string& name,
                                            double p,
                                            xml::lite::Element& parent) const
{
...
{
    assert(parent != nullptr);
    return mXmlLite.createOptionalDouble(
            xml::lite::QName(xml::lite::Uri(uri), name), p, *parent);
}
XMLElem XMLParser::createOptionalDouble(const std::string& name,
                                        const std::string& uri,
                                        const std::optional<double>& p,
...
{
    assert(parent != nullptr);
    return mXmlLite.createBooleanType(
            xml::lite::QName(xml::lite::Uri(uri), name), p, *parent);
}
XMLElem XMLParser::createBooleanType(const std::string& name,
                                     BooleanType p,
...
{
    assert(parent != nullptr);
    return &mXmlLite.createDateTime(xml::lite::QName(xml::lite::Uri(uri), name),
                                    p,
                                    *parent);
}
...
{
    assert(parent != nullptr);
    return &mXmlLite.createDate(xml::lite::QName(xml::lite::Uri(uri), name),
                                p,
                                *parent);
}
XMLElem XMLParser::createDate(const std::string& name,
...
xml::lite::Element& XMLParser::getFirstAndOnly(const xml::lite::Element& parent,
                                               const std::string& tag)
{
    return XmlLite::getFirstAndOnly(parent, tag);
}
XMLElem XMLParser::getFirstAndOnly(const xml::lite::Element* parent,
                                   const std::string& tag)
{
    assert(parent != nullptr);
...
void XMLParser::getFirstAndOnly(const xml::lite::Element& parent,
                                const std::string& tag,
                                double& value) const
{
...
xml::lite::Element* XMLParser::getOptional(const xml::lite::Element& parent,
                                           const std::string& tag)
{
    return XmlLite::getOptional(parent, tag);
}
XMLElem XMLParser::getOptional(const xml::lite::Element* parent,
                               const std::string& tag)
{
    assert(parent != nullptr);
...
bool XMLParser::parseDouble(const xml::lite::Element& element,
                            double& value) const
{
...
void XMLParser::parseDouble(const xml::lite::Element* element,
...
bool XMLParser::parseOptionalDouble(const xml::lite::Element* parent,
                                    const std::string& tag,
                                    double& value) const
{
    assert(parent != nullptr);
...
void XMLParser::parseComplex(const xml::lite::Element* element,
...
void XMLParser::parseString(const xml::lite::Element& element,
...
bool XMLParser::parseOptionalString(const xml::lite::Element& parent,
                                    const std::string& tag,
                                    std::string& value) const
{
